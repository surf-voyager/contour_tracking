function [ Probe_point,mDx,mDy,mDx_max,mDy_max] = multi_concave1_wall( x,y,h)
...
%%%%%%%%%%%%%%%%%%%%凸曲线%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if xx1>185&xx1<=221
        d1=((100-10)/(200-221))*(xx1- (200) )+ (100);
        d2=((100-10)/(200-221))*(xx2- (200) )+ (100);
      elseif xx1>221&xx1<=350
        d1=((22-10)/(275-221))*(xx1- (221) )+ (10);
        d2=((22-10)/(275-221))*(xx2- (221) )+ (10);
      end
